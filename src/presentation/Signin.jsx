              ...
              <div className="forms login-height">
                ...
                <div className="details">
                  <CustomForm onSubmit={handleSubmit} className="form-padding">
                    {formData.map((data, i) => {
                      return (
                        <FormGroup key={i} controlId={data.name}>
                          <CustomLabel label={data.label} className="mb-0">
                            {data.label}
                          </CustomLabel>
                          <CustomInput
                            ...
                            name={data.name}
                          />
                          <CustomLine className="alert-line">
                            {error[data.name]}
                          </CustomLine>
                        </FormGroup>
                      );
                    ...
                    <NavLink className="nav-otp" to="/login-with-otp">
                      Login with OTP ?
                    </NavLink>
                    <CustomButton
                      type="submit"
                    ...
                    <p className="text-center already-account">
                      ...
                      <NavLink className="nav-already-login" to="/">
                        Signup
                      </NavLink>
                    </p>
                  </CustomForm>
